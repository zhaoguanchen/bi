package com.yiche.bigdata.kylin.model;

import com.alibaba.fastjson.JSONObject;
import org.apache.commons.lang.StringUtils;
import com.yiche.bigdata.kylin.KylinDataProvider;
...
public class KylinModel2x extends KylinBaseModel {
    ...
    @Override
    public Map <String,String>  getColumnsAndType() {
         Map<String,String>   result=new HashMap<>();
         String []columnList= getColumns();
         for(int i=0;i<columnList.length;i++){
         String type= columnType.get(columnList[i]);
         result.put(columnList[i],type);
     }
        return result;
    }
