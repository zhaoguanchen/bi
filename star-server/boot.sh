...
APP_MAIN=com.yiche.bigdata.StarServerApplication
...
JAVA_OPTS=$JAVA_OPTS' -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=58062 '
#JVM类加载路径
...
SERVICE_NAME="StarServerApplication"
