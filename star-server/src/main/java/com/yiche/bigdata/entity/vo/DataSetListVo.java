...
public class DataSetListVo {
    ...
    public DataSetListVo(CommonResourceVo commonResourceVo) {
    ...
    public List<DataSetListVo> getChildren() {
        return children;
    }

    public void setChildren(List<DataSetListVo> children) {
