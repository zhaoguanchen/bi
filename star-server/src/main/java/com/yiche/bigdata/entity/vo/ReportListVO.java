...
public class ReportListVO {
    ...
    public List<ReportListVO> getChildren() {
        return children;
    }

    public void setChildren(List<ReportListVO> children) {
        this.children = children;
    }

    public ReportListVO(CommonResourceVo commonResourceVo) {
